 ...
 */
final class Version20231016164825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE status_history (id INT NOT NULL, type VARCHAR(255) NOT NULL, type_id VARCHAR(50) NOT NULL, old VARCHAR(100) NOT NULL, new VARCHAR(100) NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2F6A07CE8CDE5729C54C8C93 ON status_history (type, type_id)');
