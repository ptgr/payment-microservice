 ...
 */
final class Version20230831082603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment (id INT NOT NULL, token_id INT NOT NULL, amount INT NOT NULL, transaction_number VARCHAR(50) NOT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE token (id INT NOT NULL, item_id INT NOT NULL, method_id INT NOT NULL, token VARCHAR(50) NOT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_5F37A13B126F525E ON token (item_id)');
        $this->addSql('CREATE INDEX IDX_5F37A13B19883967 ON token (method_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5F37A13B5F37A13B126F525E ON token (token, item_id)');
        ...
        $this->addSql('ALTER TABLE token ADD CONSTRAINT FK_5F37A13B126F525E FOREIGN KEY (item_id) REFERENCES item (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE token DROP CONSTRAINT FK_5F37A13B126F525E');
